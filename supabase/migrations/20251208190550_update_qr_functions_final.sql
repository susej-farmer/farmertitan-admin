drop function if exists "public"."create_equipment_migration"(equipment_name text, p_equipment_type_id uuid, farm_id uuid, created_by_user_id uuid, equipment_model_id uuid, make_id uuid, serial_number text, year_purchased smallint, lease_owned boolean, warranty_time text, warranty_details text, custom_checklists jsonb);
